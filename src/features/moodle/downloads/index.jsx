...
const downloadItems = [
  ...
  {
    id: 4,
    title: "Moodle Template Course",
    description: "Pre-built template for training courses",
    size: "3.7 MB",
    icon: "📁"
  },
  {
    id: 5,
    title: "Learning Platform Handbook",
    description: "Complete handbook for new faculty members",
    size: "8.2 MB",
    icon: "📖"
  }
];
...
const MoodleDownloads = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="text-gray-600 mb-6">Download resources to help you get started with Moodle LMS.</p>

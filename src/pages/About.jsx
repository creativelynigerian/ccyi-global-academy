    ...
    <div className="about-page">
      ...
      <div className="about-content">
        <div className="about-section">
          <h2>🎯 Our Mission</h2>
          <p>Covenant University's Faculty Onboarding Portal is designed to help new and existing faculty members master the digital platforms essential for academic excellence.</p>
        </div>
        ...
        <div className="about-section">
          <h2>🏆 Certification</h2>
          <p>Complete all six training modules to earn your <strong>CU Faculty Onboarding Certificate</strong>. This certification demonstrates your proficiency with Covenant University's digital ecosystem.</p>
        </div>
